...
import com.damts.aulawhatsapp.databinding.ItemMensagensDestinatarioBinding
import com.damts.aulawhatsapp.databinding.ItemMensagensRemetenteBinding
...
class MensagensAdapter : Adapter<ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val mensagem = listaMensagens[position]
        when( holder ){//Testando se o holder é do tipo remetente ou destinatario
